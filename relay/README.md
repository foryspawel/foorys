...
Panel administratora używa oddzielnego hasła, a dekodery osobnych tokenów. Relay nie przechowuje haseł root i udostępnia jedynie stałą listę bezpiecznych akcji: stan, diagnostyka, odświeżenie katalogu i aktualizacja E2-Foorys.
