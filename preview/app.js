(function () {
  ...
  var fallbackManifest = {
    ...
    picons: [
      ...
      plugin_update: { id: "e2foorys", name: "E2-Foorys", description: "Aktualizacja panelu E2-Foorys z GitHuba.", version: "0.6.9" }
  };
  ...
  function buildEntries(sectionId) {
    ...
    if (sectionId === "iptv") return [
      ...
      item("Ustawienia IPTV", "Wpisz prywatny link M3U albo DNS, login i hasło. Dane zostają wyłącznie lokalnie.", "Ustawienia IPTV", "iptv-settings", "settings"),
