(function () {
  ...
  var fallbackManifest = {
    ...
    picons: [
      ...
      plugin_update: { id: "e2foorys", name: "E2-Foorys", description: "Aktualizacja panelu E2-Foorys z GitHuba.", version: "0.7.0" }
  };
